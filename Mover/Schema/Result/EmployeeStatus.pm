use utf8;
package Mover::Schema::Result::EmployeeStatus;
...
=head1 TABLE: C<employee_status>

=cut

__PACKAGE__->table("employee_status");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CEwrdRwMZwx0dwEJ9oTp8g
